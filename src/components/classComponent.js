            ...
            <div>
                <Form onSubmit={this.add} ref={this.formData}>
                    <Form.Group controlId="formBasicProductName">
                        <Form.Label>Product | Ürün</Form.Label>
                        <Form.Control type="text" placeholder="Enter Product Name" name="product_name" />
                    </Form.Group>

                    <Form.Group controlId="formBasicPrice">
                        <Form.Label>Price | Fiyat</Form.Label>
                        <Form.Control type="number" placeholder="Price in TL" name="price" />
                    </Form.Group>

                    <Form.Group controlId="formBasicQty">
                        <Form.Label>mikdar:</Form.Label>
                        <Form.Control type="number" placeholder="How many" name="qty" />
                    </Form.Group>

                    <Button variant="primary" type="submit"  className="mar" >
                        Ek Ürün 
            </Button>
                </Form>
                            ...
                            this.state.products.map((item, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>{item.price}</td>
                                        <td style={{background:item.qty > 0 ? `green`: "red"}}>{item.qty}</td>
                                        <td>
